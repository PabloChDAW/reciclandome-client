  ...
  return (
    <>
      <div className="py-10 ">
        ...
        <div
          id="mapa"
          className="mb-10 overflow-hidden border border-slate-200 shadow-[0_0_20px_3px_rgba(34,197,94,0.4)] transition-all duration-500"
        >
          ...
          {selectedPoint && (
            <section className="mt-10 p-6 rounded-2xl border border-blue-200 bg-blue-50 shadow-md">
              <h2 className="text-2xl font-semibold text-blue-800 flex items-center gap-2 mb-4">
                <span className="text-xl">📍</span> Detalles del Punto
                Seleccionado
              </h2>
