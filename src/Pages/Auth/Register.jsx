...
export default function Register() {
  ...
  return (
    <>
      <div className="p-10 sm:py-10 sm:max-w-7xl mx-auto flex flex-col items-center justify-center bg-[#f7f7f7] px-4">
        <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg space-y-6 animate-fade-in-up">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-[#166534] text-white py-3 rounded-full  hover:bg-[#14532d] transition-all duration-300 shadow-md"
            >
              REGISTRARSE
            </button>
          </form>
