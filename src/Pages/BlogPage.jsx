    ...
    return (
        <div className="bg-[#f5f6f1] py-16 px-4 md:px-12 min-h-screen">
            <div className="max-w-6xl mx-auto">
                <h1 className="text-4xl font-bold text-[#131700] mb-4 text-center">Nuestro Blog</h1>
                <p className="text-center text-gray-700 mb-12">Historias, consejos y novedades sobre reciclaje y sostenibilidad.</p>
