        ...
        <div className="bg-[#D0FDD7] opacity-20 hover:opacity-100 transition duration-700 w-full mt-0 text-gray-800 flex flex-wrap items-center justify-between px-4 py-2 ">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 w-full sm:w-auto sm:flex-row">
                <div className="flex items-center gap-1 text-xs sm:text-sm justify-center">
                    ...
                    <span className="text-[12px] lg:text-[16px] md:text-[14px] sm:text-[14px]  font-bold">contacto@reciclando.me</span>
                </div>
            </div>
            {/* Dirección */}
            <div className="flex gap-3 w-full sm:w-auto justify-center sm:justify-start mt-2 sm:mt-0">
                ...
                <span className=" text-[12px] lg:text-[16px] md:text-[14px] sm:text-[14px] font-bold">Calle de la fama, 123, Córdoba, España</span>
            </div>
