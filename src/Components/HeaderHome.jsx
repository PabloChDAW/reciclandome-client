    ...
    return (
        <header className="sticky top-0 z-[100] shadow-md">
            <div className="mx-auto px-4 py-3 bg-opacity-40 z-99 flex items-center justify-between relative">
                ...
                {/* Panel carrito */}
                <div
                    className={`fixed top-0 right-0 h-full w-full sm:w-3/5 md:w-1/2 lg:w-1/3 bg-white shadow-lg transform transition-transform duration-300 z-50 ${isCartOpen ? "translate-x-0" : "translate-x-full"
                        }`}
                >
